    ...
    <AuthenticatedLayout>
      ...
      <div className="bg-gradient-to-r from-blue-800 to-blue-600 text-white py-8">
        <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
          ...
          <p className="text-blue-100 mt-2">Consulter vos modules assignés</p>
        </div>
      </div>
          ...
          {modules.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {modules.map((module) => (
                <div
                  key={module.id}
                  className="bg-white shadow-md rounded-lg p-6 border-l-4 border-blue-500 hover:shadow-lg transition transform hover:scale-105"
                >
