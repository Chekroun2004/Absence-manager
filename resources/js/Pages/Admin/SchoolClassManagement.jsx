    ...
    <AuthenticatedLayout>
      ...
      <div className="bg-gradient-to-r from-blue-800 to-blue-600 text-white py-8">
        <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
          ...
          <p className="text-blue-100 mt-2">Créez et gérez les classes de l'établissement</p>
        </div>
      </div>
          ...
          <div className="bg-white shadow-md rounded-lg p-8 border-l-4 border-blue-500">
            <div className="flex justify-between items-center mb-6">
              ...
              <button
                ...
                className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-6 rounded-lg shadow-md hover:shadow-lg transition transform hover:scale-105"
              >
            ...
            {isFormOpen && (
              <form
                ...
                className="mb-8 p-6 bg-blue-50 rounded-lg space-y-4 border-l-4 border-blue-500"
              >
                {/* NOM */}
                <div>
                      ...
                      >
                        ...
                        <td className="border border-gray-300 px-4 py-2 text-center space-x-2">
                          <button
                            ...
                            className="bg-sky-600 hover:bg-sky-700 text-white py-2 px-4 rounded-lg text-sm shadow-md hover:shadow-lg transition transform hover:scale-105"
                          >
                            Modifier
                          </button>
                          <button
                            ...
                            className="bg-gray-500 hover:bg-gray-600 text-white py-2 px-4 rounded-lg text-sm shadow-md hover:shadow-lg transition transform hover:scale-105"
                          >
                            Supprimer
                          </button>
                        </td>
