            ...
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl shadow-lg p-5 border border-blue-200">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-semibold text-blue-900 text-sm">{session.started_at ? `${new Date(session.started_at).toLocaleDateString('fr-FR')} ${new Date(session.started_at).toLocaleTimeString('fr-FR')}` : 'Non enregistré'}</p>
                </div>
              </div>
            </div>
            <div className="bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-2xl shadow-lg p-5 border border-emerald-200">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-semibold text-emerald-900 text-sm">{session.ended_at ? `${new Date(session.ended_at).toLocaleDateString('fr-FR')} ${new Date(session.ended_at).toLocaleTimeString('fr-FR')}` : 'Non enregistré'}</p>
                </div>
              </div>
            </div>
